                                        ...
                                        <div className="col-lg-3 col-md-6">
                                            <div className="form-group">
                                                <select>
                                                    ...
                                                    <option>Promotion Boy</option>
                                                    <option>Promotion Girl</option>
                                                    <option>Mascot Boy</option>
                                                    <option>Bouncer</option>
                                                    <option>Decorator</option>
                                                    <option>Announcer</option>
                                                    <option>Stock Counter</option>
                                                    <option>Cashier</option>
                                                    <option>Delivery Boy</option>
                                                    <option>Kitchen Helper</option>
                                                    <option>Model</option>
                                                    <option>Sales Person</option>
                                                    <option>Customer Helper</option>
                    ...
                    <div className="container">
                        ...
                        <div className="row">
                            <div className="col-lg-8">
                                ...
                                <div className="m-t30">
                                    <div className="d-flex">
                                        <a className="site-button button-sm mr-auto" href="#"><i className="ti-arrow-left"></i> Prev</a>
                                        <a className="site-button button-sm" href="#">Next <i className="ti-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
